...
function About() {
	return (
		<section>
			<div
				id="om"
				className="bg-background-medium section-padding-y section-padding-x section-center mt-14 rounded-t-4xl md:!px-0 xl:!px-20"
			>
				<div className="section-wrapper section-restrict flex flex-col-reverse items-center gap-2 md:flex-row md:items-center md:gap-8 lg:gap-14">
					...
					/>
					<div className="mb-5 md:mr-10 xl:mr-0">
